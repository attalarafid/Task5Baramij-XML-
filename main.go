...
func getCustomers(w http.ResponseWriter, r *http.Request) {
	...
	for i := 0; i < len(request.Orders.Order); i++ {
		...
		if err != nil {
			fmt.Fprintln(w, "Order Data", customerID, " with Employee ID: ", employeeID, " is a Duplicate")
		} else {
			fmt.Fprintln(w, "Order Data", customerID, "with Employee ID:", employeeID, " is Created")
		}
	}
}
